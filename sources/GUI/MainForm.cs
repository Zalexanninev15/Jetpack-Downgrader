...
namespace JetpackGUI
{
    public partial class MainForm : Form
    {
        ...
        async void button1_Click(object sender, EventArgs e)
        {
            ...
            else { button1.Visible = false; darkButton4.Visible = true; }
        }
        ...
        private void pictureBox11_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                if (x64 == true) { Registry.LocalMachine.CreateSubKey(@"SOFTWARE\WOW6432Node\Rockstar Games\GTA San Andreas\Installation"); Registry.SetValue("HKEY_LOCAL_MACHINE\\SOFTWARE\\WOW6432Node\\Rockstar Games\\GTA San Andreas\\Installation", "ExePath", GamePath.Text); }
                Registry.LocalMachine.CreateSubKey(@"SOFTWARE\Rockstar Games\GTA San Andreas\Installation");
